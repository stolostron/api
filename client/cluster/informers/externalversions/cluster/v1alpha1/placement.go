	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ClusterV1alpha1().Placements(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ClusterV1alpha1().Placements(namespace).Watch(context.TODO(), options)
			},
		},
		&clusterv1alpha1.Placement{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *placementInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&clusterv1alpha1.Placement{}, f.defaultInformer)
}
