...
import (
	...
	v1alpha1 "github.com/stolostron/api/client/cluster/listers/cluster/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ClusterV1alpha1().PlacementDecisions(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ClusterV1alpha1().PlacementDecisions(namespace).Watch(context.TODO(), options)
			},
		},
		&clusterv1alpha1.PlacementDecision{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *placementDecisionInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&clusterv1alpha1.PlacementDecision{}, f.defaultInformer)
}
